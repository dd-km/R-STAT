...
# Plotly transperentna tema
gtheme <- function(x){
  ggplotly(x) |>
    layout(legend=list(
      font=list(size = 14, color = "#9D9D9D"),
      title=list(font=list(size = 14, color = "#9D9D9D")) 
      ), 
      plot_bgcolor = "rgba(0,0,0,0)",
      paper_bgcolor = "rgba(0,0,0,0)",
      xaxis = list( 
        title = list(font=list(size=16, color="#9D9D9D")),
        gridcolor = "rgba(0,0,0,0)",
        tickfont = list(size=14, color="#9D9D9D")
      ),
      yaxis = list(
        title = list(font=list(size=16, color="#9D9D9D")),
        gridcolor = "rgba(0,0,0,0)",
